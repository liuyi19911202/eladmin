...
@Log4j2
@Component
public class AwemeResult4Repository extends BaseElasticSearchRepository<AwemeResultDto> {
    ...
    public CdosApiPageResponse<AwemeResultDto> listForPage(PageInfo page, AbstractQueryBuilder boolQueryBuilder,
        ...
        return super.listForPage(index + "_" + DateUtil.formatDate(DateUtil.getCurrentDate()) + "_4", doc, page,
    ...
    public List<AwemeResultDto> listForPage(AbstractQueryBuilder boolQueryBuilder, SortBuilder sortBuilder, Integer n,
        Class clazz) {
        return super.listForPage(index + "_" + DateUtil.formatDate(DateUtil.getCurrentDate()) + "_4", doc,
            boolQueryBuilder, sortBuilder, n, clazz);
    }

    public Boolean deleteIndex() {
        return super.deleteIndex(index + "_" + DateUtil.formatDate(DateUtil.getCurrentDate()) + "_4");
    }
